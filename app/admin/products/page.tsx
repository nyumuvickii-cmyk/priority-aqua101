    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="p-6">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-500">Products Management</h2>
          <p className="text-gray-400 mt-2">Add, edit, delete products with inventory tracking</p>
        </div>
      </main>
    </div>
  );
